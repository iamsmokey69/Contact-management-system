...
void PrintLineWithSpace(char *Name[20],char ContactInfo){
    ...
    int TotalSpace = 0;
    if(ContactInfo == 'n'){
        TotalSpace = 20 - FormatedNameLenght; 
    }else if(ContactInfo == 'p'){
        TotalSpace = 20 - FormatedNameLenght;
    }else if(ContactInfo == 'e'){
        TotalSpace = 30 - FormatedNameLenght;
    }
...
void AboutUs(){
    ...
    printf("\n\n\n\t\t\tAbout US\n");
    printf("\t\t======================\n");
    printf("\t\t[i] This program is managed by Prashant Dwivedi \n");
    printf("\t\t[i] Prashant is currently trying to learn new features daily\n");
    printf("\t\t[>] Trying to learn computer programming and related technology \n");
    printf("\t\t======================\n\t\t");
    GoBackOrExit();
}
